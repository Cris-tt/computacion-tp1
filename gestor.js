// ─── GestorSenial ─────────────────────────────────────────────────────────────
// Filtra y deriva cualquier señal continua (volumen, pitch, etc.)
// Igual al original; anchoGestor se define en tp1_computacion.js
...
class GestorSenial {
  ...
  actualizar(entrada_) {
    ...
    // Normaliza cualquier entrada al rango [0,1].
    ...
    this.filtrada =
      ...
      this.mapeada[this.puntero] * (1 - this.f);
    this.histFiltrada[this.puntero] = this.filtrada;

    // Derivada amplificada.
